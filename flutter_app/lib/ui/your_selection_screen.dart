        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Colors.grey.withOpacity(0.3), // Lighter grey
                  blurRadius: 15,
                  spreadRadius: 10,
                  offset: Offset(0, 3),
                ),
                BoxShadow(
                  color: Colors.white, // Center color (white)
                  blurRadius: 15,
                  spreadRadius: 15,
                  offset: Offset(0, 3),
                ),
                BoxShadow(
                  color: Colors.grey.withOpacity(0.3), // Darker grey
                  blurRadius: 15,
                  spreadRadius: 10,
                  offset: Offset(0, 3),
                ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(
                              width:
                                  10), // Adjust the space between image and text
                          Column(
                            children: [
                              Text("BMW GLA45",
                                  style: TextStyle(
